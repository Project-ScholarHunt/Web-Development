                ...
                <nav className="mt-6">
                    <ul>
                        ...
                        <li className="bg-blue-100 hover:bg-blue-200">
                            <Link to="/scholarships" className="block px-4 py-2 text-blue-700">Scholarships</Link>
                        </li>
                        <li className="hover:bg-gray-200">
                            <Link to="/users" className="block px-4 py-2 text-gray-700">Users</Link>
                        </li>
                        <li className="hover:bg-gray-200">
                            <Link to="/settings" className="block px-4 py-2 text-gray-700">Settings</Link>
                        </li>
                    </ul>
                </nav>
            </aside>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full p-2 border border-gray-300 rounded"
                                />
                                {formData.logo && <p className="text-xs mt-1">Current: {formData.logo}</p>}
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full p-2 border border-gray-300 rounded"
                                />
                                {formData.thumbnail && <p className="text-xs mt-1">Current: {formData.thumbnail}</p>}
                            </div>
                            <div>
                        ...
                        <tbody>
                            {filteredItems.map(item => (
                                <tr key={item.id} className="border-t">
                                    <td className="p-2">{item.scholarshipName}</td>
                                    <td className="p-2">{item.partner}</td>
                                    <td className="p-2">{item.quota}</td>
                                    <td className="p-2">{item.timeLimit}</td>
                                    <td className="p-2">
